...
public class GetDataCommand {
   ...
   */
  public GetDataCommand(CommandInfoImpl context) {
  ...
  public void run(String ticker) throws IOException {
    ...
    if (!file.exists()) {
      ...
      context.getView().writeMessage("Please wait while we get the data...\n");
      ...
      context.getView().writeMessage("This file is already contained in the program\n");
    }
  }
